  ...
  ###################################################################################
{
  ...
  # Enable pam-reattach for tmux Touch ID support
  ...
  system = {
    ...
    activationScripts.postActivation.text = ''
      # Remove quarantine attribute from apps
      echo "Removing quarantine attributes from apps..."
  ...
  # Create symlink for /etc/ssl/cert.pem
